...
3. **Enable in Project**:
   ...
   // Add to your ML4T book project's .claude/settings.json
   {
     ...
     "enabledPlugins": {
       ...
       "writing-skills@local": true  // Optional: Enhanced writing methodologies
     }
   }
   ```

4. **Optional: Enable Writing Skills** (recommended for v1.1+):

   The writing-skills plugin provides enhanced writing methodologies:
   - **pyramid-principle**: Hierarchical structure (answer first, then supporting points)
   - **scqa-framework**: Narrative structure (Situation-Complication-Question-Answer)
   - **diataxis-framework**: Documentation structure (tutorials, how-tos, reference, explanation)
   - **topic-sentence-method**: Clear paragraph structure
   - **information-mapping**: DITA-inspired organization
   - **excellent-writing**: 15 principles for clarity and precision

   These skills are **optional** - the ml3t-coauthor plugin works perfectly without them, but they can enhance the quality and structure of generated content.
...
**Optional Dependencies**: writing-skills@local (for enhanced writing methodologies)
**Last Updated**: 2025-11-01

## Version History

**v1.1.0** (2025-11-01):
- Added optional writing-skills@local dependency for enhanced writing methodologies
- When enabled, provides access to pyramid-principle, scqa-framework, diataxis-framework, and other writing skills
- Fully backward compatible - writing-skills is optional and framework works without it
- No changes to core commands or workflow

**v1.0.0** (2025-10-11):
- Initial release
- 4-phase workflow (research, outline, writing, review)
- Integration with ml3t-researcher
- Git-based collaboration workflow
- 12 commands and 4 specialized agents
