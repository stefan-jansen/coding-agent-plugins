...
|---------|-------------------|--------------|
| **Storage** | Global `~/.claude/plans/` | Project-local `.workspace/work/` |
...
```
.workspace/work/current/[work-unit]/
...
- **Issues**: [GitHub Issues](https://github.com/stefan-jansen/coding-agent-toolkit/issues)
- **Discussions**: [GitHub Discussions](https://github.com/stefan-jansen/coding-agent-toolkit/discussions)
