...
**Work Unit**: .claude/work/web/[task-slug]/
...
```bash
# Archive work unit
mv .claude/work/web/[task-slug]/ .claude/work/archives/web-[task-slug]-2025-10-16/
...
Work unit archived to: .claude/work/archives/web-[task-slug]-2025-10-16/
