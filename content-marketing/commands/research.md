...
if [ ! -f .agents/work/content/${CONTENT_PIECE}/positioning-manifest.json ]; then
...
**File**: `.agents/work/content/[content-piece-name]/research-report.md`
...
Research report created: .agents/work/content/caf-white-paper/research-report.md
